      ...
      <g id="svga-group-wrapper">
        ...
        <g id="svga-group-humanwrap-move" transform="matrix(1,0,0,1,0,0)">
          <g
            ...
            transform="matrix(0.8499995000000001,0,0,0.8499995000000001,14.960298242433538,16.252054695948587)"
          >
            <g
              id="svga-group-hair-back-move"
              transform="matrix(1,-1.7453294018365817e-9,1.7453294018365817e-9,1,-2.6179941414739005e-7,1.745329427649267e-7)"
            >
            ...
            <g id="svga-group-chinshadow-single">
              <path
                ...
                fill="url(#SvgjsLinearGradient3100)"
                opacity="1"
              />
            </g>
            <g id="svga-group-clothes-single">
              ...
              <path
                id="SvgjsPath5264"
                d="M207.736 234.4c-0.408 0.005-0.99 0.016-1.725 0.028 -3.039-16.858-6.315-31.74-17.834-43.399 -10.539-8.782-28.915-5.961-42.535-10.969 -12.926 14.626-29.187 23.197-43.576 29.279 14.264-9.024 36.136-23.31 43.687-32.288 5.783 1.338 33.561 3.724 43.194 10.297C200.992 195.288 206.536 216.754 207.736 234.4zM51.55 177.73c-0.023-0.025-26.379 3.491-31.163 5.278 -20.983 7.027-28.567 31.061-28.687 51.396 0.274 0.006 0.55 0.01 0.824 0.016 1.106-15.271 5.857-28.244 16.094-39.269 10.321-11.26 29.183-10.47 43.568-13.491 15.293 15.293 35.334 23.124 49.879 27.679C79.899 198.128 64.633 192.14 51.55 177.73z"
                fill="#4d7e86"
                stroke-width="none"
                opacity="1"
                stroke="none"
                ...
                <g id="svga-group-eyes-right" transform="matrix(1,0,0,1,0,0)">
                  <g id="svga-group-eyesback-right">
                    <path
                      ...
                      fill="url(#SvgjsRadialGradient4814)"
                      opacity="1"
                    />
                  </g>
                  <g
                  ...
                  <g id="svga-group-eyesfront-right">
                    ...
                    <path
                      ...
                      fill="url(#SvgjsRadialGradient4853)"
                      opacity="1"
                    />
                    <path
                      id="SvgjsPath4857"
                      ...
                      fill="url(#SvgjsRadialGradient4858)"
                      opacity="1"
                    />
                    <path
                      id="SvgjsPath4861"
